...
public class PrimeSnakeSolver extends JPanel {
	...
	public static void main(String[] args) {
		...
		solver.solve(
				"",
				5000);

		// TODO: 
		
		// The example above has a score of 24, but it is too small, we need a snake of length 5000:
		// solver.solve("?", 5000);
	}
